...
use crate::harness::api_key::{OPENAI_ENV_VARS, resolve_api_key};
use crate::harness::provider::{ApiProvider, Result};
use crate::harness::sse::read_openai_sse_stream;
...
impl ApiProvider for OpenAiApiProvider {
    ...
    async fn stream_chat(
        ...
        let (content, acc_tool_calls, usage, stop_reason) =
            read_openai_sse_stream(resp, &chunk_tx, &self.cancel).await?;
